...
try:
    ...
    MultiLinkConnection = mysql.connector.connect(host="localhost", user="root", password="Bh101299@", database="MultiLink")
    ...
    logging.error("Error executing database query: %s", error)
